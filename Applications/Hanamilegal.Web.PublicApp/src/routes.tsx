import { DevelopingPage, ErrorPage, HomePage, JurisprudencePage, NotFoundPage } from "pages";
...
export const ROUTES: React.ReactNode = (
  <Routes>
    ...
    <Route path={getRoutePath(VIEW_PANELS.developing)} element={<DevelopingPage />} />
    <Route path={getRoutePath(VIEW_PANELS.error)} element={<ErrorPage />} />
    <Route path={getRoutePath(VIEW_PANELS.home)} element={<HomePage />} />
    <Route path={getRoutePath(VIEW_PANELS.jurisprudence)} element={<JurisprudencePage />} />
